 ...
 */
	...
	//Setting Date Time Format 
		...
		// $image_name = date("j-M-Y")."-2.png";
		$image_name = date("j-M-Y");
		$image_path = "code/".$image_name;

	// $query = "INSERT INTO barcode(image,image_value)VALUES('{$image_path}','{$text}')";
	// $data = mysql_query($query);

	// $query = "SELECT id FROM barcode ORDER BY id DESC";
	// $data = mysql_query($query);
